...
<head>
  ...
  <title>Add Skilled Task - REDA</title>
...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      ...
      <h3 class="card-title mt-2 mb-1">Add Skilled Task</h3>
      <p class="subtitle">(REDA Skilled Manpower)</p>
    </div>

    <form action="{{ route('redaskilledmanpower.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('progress') is-invalid @enderror" id="progress" name="progress" placeholder="e.g., 60% Complete" value="{{ old('progress') }}">
      ...
      <div class="d-grid gap-2">
        ...
        <a href="{{ route('redaskilledmanpower.index') }}" class="btn btn-danger">Back</a>
      </div>
    </form>
  </div>
