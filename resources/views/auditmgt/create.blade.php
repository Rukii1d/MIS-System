...
<head>
  ...
  <title>Add Audit Task - REDA</title>
...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      ...
      <h3 class="card-title mt-2 mb-1">Add Audit Task</h3>
      <p class="subtitle">(REDA Audit Management)</p>
    </div>

    <form action="{{ route('auditmgt.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="d-grid gap-2">
        ...
        <a href="{{ route('auditmgt.index') }}" class="btn btn-danger">Back</a>
      </div>
