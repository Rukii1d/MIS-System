...
<head>
  ...
  <title>Add Economy Task - REDA</title>
...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      <i class="bi bi-briefcase-fill" style="font-size: 2rem; color: #2575fc;"></i>
      <h3 class="card-title mt-2 mb-1">Add Economy Task</h3>
      <p class="subtitle">(REDA Economic Development)</p>
    </div>

    <form action="{{ route('econdev.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="d-grid gap-2">
        ...
        <a href="{{ route('econdev.index') }}" class="btn btn-danger">Back</a>
      </div>
    </form>
  </div>
