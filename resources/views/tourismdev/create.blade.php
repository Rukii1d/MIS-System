...
<head>
  ...
  <title>Add Tourism Task - REDA</title>
...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      <i class="bi bi-map-fill" style="font-size: 2rem; color: #11998e;"></i>
      <h3 class="card-title mt-2 mb-1">Add Tourism Task</h3>
      <p class="subtitle">(REDA Tourism Development)</p>
    </div>

    <form action="{{ route('tourismdev.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="d-grid gap-2">
        ...
        <a href="{{ route('tourismdev.index') }}" class="btn btn-danger">Back</a>
      </div>
