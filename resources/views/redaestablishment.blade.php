...
<div class="main-panel">
  <div class="content-wrapper">
    ...
    <div class="svg-container">
      <img src="{{ asset('svg/116.gif') }}" alt="Looping GIF">
    </div>
    ...
    <div class="row cards-row">
      <div class="col-md-3 col-sm-6 col-10 d-flex">
        <div class="card card-custom flex-fill">
          <div class="card-body flex-fill">
            <h4>HRM</h4>
            <a href="{{ url('/redahrm') }}" class="btn rounded-pill mt-3">Go</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-6 col-10 d-flex">
        <div class="card card-custom flex-fill">
          <div class="card-body flex-fill">
            <h4>Tapol</h4>
            <a href="{{ url('/tapol') }}" class="btn rounded-pill mt-3">Go</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-6 col-10 d-flex">
        <div class="card card-custom flex-fill">
          <div class="card-body flex-fill">
            <h4>AuditMgt</h4>
            <a href="{{ url('/auditmgt') }}" class="btn rounded-pill mt-3">Go</a>
          </div>
        </div>
      </div>
    </div>
