...
<head>
  ...
  <title>Add Security Service Member - REDA</title>
...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      ...
      <h3 class="card-title mt-2 mb-1">Add Security Service Member</h3>
    ...
    <form action="{{ route('redasecurityservicemembers.store') }}" method="POST" enctype="multipart/form-data" class="mt-3">
      @csrf

      <div class="mb-3">
        <label for="etf_no" class="form-label">ETF NO.</label>
        <input type="text" class="form-control @error('etf_no') is-invalid @enderror" id="etf_no" name="etf_no" value="{{ old('etf_no') }}" required>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('nic_no') is-invalid @enderror" id="nic_no" name="nic_no" value="{{ old('nic_no') }}" required>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('salary_bank_branch_no') is-invalid @enderror" id="salary_bank_branch_no" name="salary_bank_branch_no" value="{{ old('salary_bank_branch_no') }}">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('acc_no') is-invalid @enderror" id="acc_no" name="acc_no" value="{{ old('acc_no') }}">
      ...
      <div class="mb-3">
        ...
        <input type="date" class="form-control @error('date_joined') is-invalid @enderror" id="date_joined" name="date_joined" value="{{ old('date_joined') }}">
      ...
      <div class="mb-3">
        ...
        <input type="date" class="form-control @error('date_resigned') is-invalid @enderror" id="date_resigned" name="date_resigned" value="{{ old('date_resigned') }}">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('ds_division') is-invalid @enderror" id="ds_division" name="ds_division" value="{{ old('ds_division') }}">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('gn_division') is-invalid @enderror" id="gn_division" name="gn_division" value="{{ old('gn_division') }}">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('police_division') is-invalid @enderror" id="police_division" name="police_division" value="{{ old('police_division') }}">
      ...
      <div class="mb-3">
        ...
        <select class="form-select @error('marital_status') is-invalid @enderror" id="marital_status" name="marital_status">
          ...
          <option value="SINGLE" {{ old('marital_status') == 'UNMARRIED' ? 'selected' : '' }}>UNMARRIED</option>
      ...
      <div class="mb-3">
        ...
        <input type="number" class="form-control @error('no_of_children') is-invalid @enderror" id="no_of_children" name="no_of_children" value="{{ old('no_of_children') }}">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control @error('education_qualifications') is-invalid @enderror" id="education_qualifications" name="education_qualifications" rows="3">{{ old('education_qualifications') }}</textarea>
        @error('education_qualifications') <div class="invalid-feedback">{{ $message }}</div> @enderror
      </div>

      <div class="mb-3">
        <label for="experience" class="form-label">Experience</label>
        <textarea class="form-control @error('experience') is-invalid @enderror" id="experience" name="experience" rows="3">{{ old('experience') }}</textarea>
      ...
      <div class="mb-3">
        ...
        <select class="form-select @error('position_category') is-invalid @enderror" id="position_category" name="position_category" required>
          ...
          <option value="LSO" {{ old('position_category') == 'LSO' ? 'selected' : '' }}>LSO</option>
          <option value="SO" {{ old('position_category') == 'SO' ? 'selected' : '' }}>SO</option>
          <option value="OIC" {{ old('position_category') == 'OIC' ? 'selected' : '' }}>OIC</option>
        </select>
      ...
      <div class="d-grid gap-2 mt-4">
        ...
        <a href="{{ route('redasecurityservicemembers.index') }}" class="btn btn-danger">Back</a>
      </div>
    </form>
  </div>
