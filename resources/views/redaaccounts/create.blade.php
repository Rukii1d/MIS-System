...
<head>
  ...
  <title>Add Account Task - REDA</title>
...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      <i class="bi bi-calculator-fill" style="font-size: 2rem; color: #4e4376;"></i>
      <h3 class="card-title mt-2 mb-1">Add Account Task</h3>
      <p class="subtitle">(REDA Accounts)</p>
    </div>

    <form action="{{ route('redaaccounts.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="d-grid gap-2">
        ...
        <a href="{{ route('redaaccounts.index') }}" class="btn btn-danger">Back</a>
      </div>
