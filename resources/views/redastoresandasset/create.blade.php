...
<head>
  ...
  <title>Add Stores and Asset Task - REDA</title>
...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      ...
      <h3 class="card-title mt-2 mb-1">Add Stores and Asset Task</h3>
      <p class="subtitle">(REDA Stores and Asset)</p>
    </div>

    <form action="{{ route('redastoresandasset.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="d-grid gap-2">
        ...
        <a href="{{ route('redastoresandasset.index') }}" class="btn btn-danger">Back</a>
      </div>
