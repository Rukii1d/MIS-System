...
<head>
  ...
  <title>Create Cleaning Task - REDA</title>
...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      ...
      <h3 class="card-title mt-2 mb-1">Create Cleaning Task</h3>
    ...
    <form action="{{ route('redacleaningservice.store') }}" method="POST" enctype="multipart/form-data" class="mt-3">
      @csrf
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('progress') is-invalid @enderror" id="progress" name="progress" value="{{ old('progress') }}">
