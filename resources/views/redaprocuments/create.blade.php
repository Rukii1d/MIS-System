...
<head>
  ...
  <title>Add Procurement Task - REDA</title>
...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      <i class="bi bi-file-earmark-text" style="font-size: 2rem; color: #2575fc;"></i>
      <h3 class="card-title mt-2 mb-1">Add Procurement Task</h3>
      <p class="subtitle">(REDA Procurement)</p>
    </div>

    <form action="{{ route('redaprocuments.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="d-grid gap-2">
        ...
        <a href="{{ route('redaprocuments.index') }}" class="btn btn-danger">Back</a>
      </div>
