...
<head>
  ...
  <title>Add Security Task - REDA</title>
...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      ...
      <h3 class="card-title mt-2 mb-1">Add Security Task</h3>
      <p class="subtitle">(REDA Security Service)</p>
    </div>

    <form action="{{ route('redasecurityservice.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="d-grid gap-2">
        ...
        <a href="{{ route('redasecurityservice.index') }}" class="btn btn-danger">Back</a>
      </div>
