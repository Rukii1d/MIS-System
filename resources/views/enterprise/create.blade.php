...
<head>
  ...
  <title>Add Enterprise Task - REDA</title>
...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      <i class="bi bi-building" style="font-size: 2rem; color: #11998e;"></i>
      <h3 class="card-title mt-2 mb-1">Add Enterprise Task</h3>
    ...
    <form action="{{ route('enterprise.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('progress') is-invalid @enderror" id="progress" name="progress" placeholder="e.g., 75% Complete" value="{{ old('progress') }}">
      ...
      <div class="d-grid gap-2">
        ...
        <a href="{{ route('enterprise.index') }}" class="btn btn-danger">Back</a>
      </div>
