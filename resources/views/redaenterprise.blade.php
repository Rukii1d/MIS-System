...
<div class="main-panel">
  <div class="content-wrapper">
    ...
    <div class="svg-container">
      <img src="{{ asset('svg/115.gif') }}" alt="Looping GIF">
    </div>
    ...
    <div class="row cards-row">
      <div class="col-md-3 col-sm-6 col-10 d-flex">
        <div class="card card-custom flex-fill">
          <div class="card-body flex-fill">
            ...
            <a href="{{ url('/enterprise') }}" class="btn rounded-pill mt-3">Go</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-6 col-10 d-flex">
        <div class="card card-custom flex-fill">
          <div class="card-body flex-fill">
            <h4>Economy Development</h4>
            <a href="{{ url('/econdev') }}" class="btn rounded-pill mt-3">Go</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-6 col-10 d-flex">
        <div class="card card-custom flex-fill">
          <div class="card-body flex-fill">
            ...
            <a href="{{ url('/tourismdev') }}" class="btn rounded-pill mt-3">Go</a>
          </div>
        </div>
      </div>
    </div>
