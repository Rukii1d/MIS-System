...
<head>
  ...
  <title>Add Hotel School Task - REDA</title>
...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      ...
      <h3 class="card-title mt-2 mb-1">Add Hotel School Task</h3>
      <p class="subtitle">(REDA Hotel School)</p>
    </div>

    <form action="{{ route('redahotelschool.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="d-grid gap-2">
        ...
        <a href="{{ route('redahotelschool.index') }}" class="btn btn-danger">Back</a>
      </div>
