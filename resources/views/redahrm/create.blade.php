...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      ...
      <h3 class="card-title mt-2 mb-1">Add HRM Task</h3>
      <p class="subtitle">(REDA HRM)</p>
    </div>

    <form action="{{ route('redahrm.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="d-grid gap-2">
        ...
        <a href="{{ route('redahrm.index') }}" class="btn btn-danger">Back</a>
      </div>
