...
<head>
    ...
    <title>Register - REDA MIS System</title>
...
<body>
    <div class="register-card">
        <h2>Register</h2>
        <form id="registerForm" action="{{ URL::to('registerUser') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <span class="error-message" id="file-error">File is required</span>
            </div>
