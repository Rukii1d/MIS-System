...
<head>
    ...
    <title>REDA Language Center</title>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h3 class="card-title mb-0">REDA Language Center</h3>
                                  @if(session()->get('type') === 'Admin')
                                <a href="{{ route('redalanguagecenter.create') }}" class="btn btn-dark">
                                        ...
                                        @forelse ($records as $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('redalanguagecenter.edit', $item->id) }}" class="btn btn-sm btn-primary" title="Edit">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </a>
                                                    <form action="{{ route('redalanguagecenter.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this task?');">
                                                        @csrf
                                                        @method('DELETE')
