...
<head>
  ...
  <title>Add Language Center Task - REDA</title>
...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      ...
      <h3 class="card-title mt-2 mb-1">Add Language Center Task</h3>
      <p class="subtitle">(REDA Language Center)</p>
    </div>

    <form action="{{ route('redalanguagecenter.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="d-grid gap-2">
        ...
        <a href="{{ route('redalanguagecenter.index') }}" class="btn btn-danger">Back</a>
      </div>
