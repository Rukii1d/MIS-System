...
<head>
  ...
  <title>Add Salary Task - REDA</title>
...
<body>
  ...
  <div class="card">
    <div class="text-center mb-4">
      <i class="bi bi-cash-stack" style="font-size: 2rem; color: #2575fc;"></i>
      <h3 class="card-title mt-2 mb-1">Add Salary Task</h3>
      <p class="subtitle">(REDA Salary)</p>
    </div>

    <form action="{{ route('redasalary.store') }}" method="POST" enctype="multipart/form-data" class="mt-3">
      @csrf
      ...
      <div class="d-grid gap-2">
        ...
        <a href="{{ route('redasalary.index') }}" class="btn btn-danger">Back</a>
      </div>
